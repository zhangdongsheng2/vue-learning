module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    nav: [
      ...
      { text: '谷歌', link: 'http://www.google.com/' },
      {
        text: '学习路线',
        items: [
          { text: '前端', link: 'http://www.baidu.com/' },
          { text: 'Java', link: 'http://www.baidu.com/' },
          { text: '大数据', link: 'http://www.baidu.com/' }
        ]
      },
      { text: '全套视频资料', link: 'http://www.baidu.com/' },
    ],
    sidebar: [ // 左侧导航
      '00_课程介绍',
      {
